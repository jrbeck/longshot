...
g++ source/*.cpp source/dungeon/*.cpp source/feature/*.cpp -w -I source -I source/include -I /opt/X11/include -I /users/jbeck/src/include -l SDL2 -framework SDL2_mixer -framework SDL2_image -framework SDL2_ttf -framework OpenGL -Wl,-rpath=/Library/Frameworks -o Release/longshot
