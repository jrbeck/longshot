...
int perm[512] = {151, 160, 137, 91, 90, 15, 131, 13, 201, 95, 96, 53, 194, 233, 7, 225,
  ...
  222, 114, 67, 29, 24, 72, 243, 141, 128, 195, 78, 66, 215, 61, 156, 180, 151, 160, 137,
  91, 90, 15, 131, 13, 201, 95, 96, 53, 194, 233, 7, 225, 140, 36, 103, 30, 69, 142, 8, 99,
  37, 240, 21, 10, 23, 190, 6, 148, 247, 120, 234, 75, 0, 26, 197, 62, 94, 252, 219, 203,
  ...
  230, 220, 105, 92, 41, 55, 46, 245, 40, 244, 102, 143, 54, 65, 25, 63, 161, 1, 216, 80,
  73, 209, 76, 132, 187, 208, 89, 18, 169, 200, 196, 135, 130, 116, 188, 159, 86, 164, 100,
  109, 198, 173, 186, 3, 64, 52, 217, 226, 250, 124, 123, 5, 202, 38, 147, 118, 126, 255,
...
double noise (double xin, double yin, double zin) {
  ...
  double G3 = 1.0 / 6.0;
  double t = static_cast<double>(i + j + k) * G3;
  double X0 = i - t;
  double Y0 = j - t;
  double Z0 = k - t;
  double x0 = xin - X0;
  ...
  double x1 = x0 - static_cast<double>(i1) + G3;
  double y1 = y0 - static_cast<double>(j1) + G3;
  double z1 = z0 - static_cast<double>(k1) + G3;
  double x2 = x0 - static_cast<double>(i2) + (2.0 * G3);
  double y2 = y0 - static_cast<double>(j2) + (2.0 * G3);
  double z2 = z0 - static_cast<double>(k2) + (2.0 * G3);
