  ...
  mSdlGlcontext(NULL)
{
  ...
  mWindowedMode.screen_w = //640;
    static_cast<int>(static_cast<double>(mDesktopMode.screen_w) * 0.9);
  mWindowedMode.screen_h = //480;
    static_cast<int>(static_cast<double>(mDesktopMode.screen_h) * 0.9);
