...
void BlockTypeDataContainer::loadBlockTypeData() {
  ...
  mData[BLOCK_TYPE_PLANT_1].lightAttenuation = 4;
  mData[BLOCK_TYPE_PLANT_1].solidityType = BLOCK_SOLIDITY_TYPE_PLANT;
  mData[BLOCK_TYPE_PLANT_1].blocksVisibility = 0.0;

  mData[BLOCK_TYPE_PLANT_2].lightAttenuation = 6;
  mData[BLOCK_TYPE_PLANT_2].solidityType = BLOCK_SOLIDITY_TYPE_PLANT;
  mData[BLOCK_TYPE_PLANT_2].blocksVisibility = 0.0;
