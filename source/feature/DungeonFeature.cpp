...
void DungeonFeature::hollowOutDungeon( DungeonUtil* dungeon, WorldMap& worldMap, const v2di_t& cornerIndex, int dungeonSide, int height, int scale ) {
	int worldX = cornerIndex.x * WORLD_CHUNK_SIDE;
	int worldZ = cornerIndex.y * WORLD_CHUNK_SIDE;
...
void DungeonFeature::addLights( World& world, DungeonUtil* dungeon, const v2di_t& cornerIndex, int dungeonSide, int ceilingHeight, int scale ) {
...
void DungeonFeature::addMonsterGenerators( World& world, DungeonUtil* dungeon, const v2di_t& cornerIndex, int dungeonSide, int ceilingHeight, int scale ) {
