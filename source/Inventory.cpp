...
int Inventory::getNextFreeBackpackSlot (void) {
	for (size_t i = 0; i < mBackpack.size (); i++) {
		if (mBackpack[i] == 0) {
			return i;
		}
...
bool Inventory::swapBackPackItemIntoPrimary (void) {
...
bool Inventory::swapBackPackItemIntoSecondary (void) {
...
void Inventory::nextBackPackItem (void) {
...
void Inventory::previousBackPackItem (void) {
