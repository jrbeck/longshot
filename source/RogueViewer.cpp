...
//	mWorldMapView.setWorldMap(&mWorldMap);
}
...
void RogueViewer::setupOpenGl (void) {
...
// handle an SDL_Event
int RogueViewer::handleInput (void) {
	int quit = 0;
	mMouseMoved = 0;
...
void RogueViewer::generateNewMap (void) {
